...
namespace ygo {
	...
	private:
		...
		AccessibilityDeckFocus::CardStack deckLooker = AccessibilityDeckFocus::CardStack::MAIN_DECK;
		AccessibilityDeckFocus::CardStack deckEditor = AccessibilityDeckFocus::CardStack::MAIN_DECK;
