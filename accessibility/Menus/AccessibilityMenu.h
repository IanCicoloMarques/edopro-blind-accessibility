...
namespace ygo {
	...
	private:
		...
		std::vector<int> menuMainEnums = { MenuType::MainMenu::MM_ONLINE_DUEL, MenuType::MainMenu::MM_SP_DUEL, MenuType::MainMenu::MM_PUZZLES, MenuType::MainMenu::MM_REPLAY, MenuType::MainMenu::MM_DECK_EDITOR, MenuType::MainMenu::MM_GAME_OPTIONS };
