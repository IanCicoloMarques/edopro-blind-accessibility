...
namespace ygo {
	...
	private:
		...
		void SelectFieldSlotHandAllowed(int slot, const AccessibilityFieldFocus::Player& player = AccessibilityFieldFocus::Player::PLAYER);
		...
		void SelectFieldSlot(int slot, const AccessibilityFieldFocus::Player& player = AccessibilityFieldFocus::Player::PLAYER);
		...
		void DisplayTable(const irr::SEvent& event, AccessibilityFieldFocus::Field fieldLooker,
		                  AccessibilityFieldFocus::Player displayedField);
